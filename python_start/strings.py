...
string.isalpha() # строка состоит только из цифр
string.isalnum() # состоит ли строка только из букв и цифр и одновременно
string.isspace() # состоит ли из неотображаемых символов
string.islower() # состоит ли строка весь из маленьких букв
string.isupper()  # состоит ли строка весь из ЗАГЛАВНЫХ букв
string.istitle # начинается ли с Заглавной буквы
string.endswith('123')  # закаончивается ли строка из()
string.startswith('My') #начинается ли строка из ()
